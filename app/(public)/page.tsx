...
const fallbackMembres: Membre[] = [
  {
    ...
    bio: "Graduat en Ciències Polítiques i de l'Administració (UPF). Emprenedor de Platja d'Aro amb experiència internacional. Defensor de la seguretat local i del teixit autònom i comercial.",
    foto: null,
    ordre: 1,
    actiu: true,
    created_at: new Date().toISOString()
  },
  {
    ...
    bio: "Empresari del sector del lleure i l'oci a Platja d'Aro. President de l'Associació Penya Barça Fans d'Aro i ferm defensor de l'associacionisme cultural i esportiu local.",
    foto: null,
    ordre: 2,
    actiu: true,
    created_at: new Date().toISOString()
