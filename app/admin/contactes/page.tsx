  ...
  return (
    <div className="space-y-6 text-xs">
      ...
      <div className="border-b border-neutral-200 pb-4">
        ...
        <p className="text-sm text-neutral-500 mt-1">Llegeix i respon els missatges enviats a través del formulari públic de contacte.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          {loading ? (
            ...
            <div className="bg-white border border-neutral-200 rounded-lg p-8 text-center text-neutral-400 shadow-sm">
              La bústia de contacte està buida.
            </div>
          ) : (
            <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden shadow-sm divide-y divide-neutral-100 max-h-[70vh] overflow-y-auto font-mono">
              {contactes.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-[11px] text-neutral-500 line-clamp-1 mt-1 font-sans font-normal">
                      {c.missatge}
                    </p>
                  </button>
                )
            ...
            <div className="bg-white border border-neutral-200 rounded-lg p-6 shadow-sm space-y-6">
              ...
              <div className="flex flex-wrap items-start justify-between gap-4 border-b border-neutral-100 pb-4">
                <div>
                  ...
                  <a href={`mailto:${missatgeObert.email}`} className="text-xs font-semibold text-primary hover:underline block mt-0.5 font-mono">
                    {missatgeObert.email}
                  </a>
                </div>
              ...
              {/* Cos del missatge */}
              <div className="text-xs text-neutral-700 leading-relaxed bg-neutral-50 border border-neutral-100 rounded-lg p-4 font-normal whitespace-pre-wrap">
              ...
              <div className="flex justify-between items-center gap-4 pt-4 border-t border-neutral-100">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 rounded border border-red-100 px-4 py-2.5 text-[11px] font-bold text-red-600 bg-white hover:bg-red-50"
                >
                  <Trash size={14} />
                  Eliminar
                </button>
                ...
                <a
                  href={`mailto:${missatgeObert.email}?subject=Re: Missatge a Aliança Catalana Castell d'Aro, Platja d'Aro i s'Agaró`}
                  className="inline-flex items-center justify-center gap-1.5 rounded bg-primary text-white px-5 py-2.5 text-[11px] font-bold shadow hover:bg-primary-dark"
                >
                  <Reply size={14} />
